      ...
      <div className="mx-auto max-w-2xl">
        ...
        {error && (
          <div className="rounded-xl border border-red-200 bg-red-50 p-4 text-red-800">
            ...
            <p className="mt-2 text-sm">
              Ensure the <code className="rounded bg-red-100 px-1">inventory_items</code> table exists
              in Supabase with columns: id, school_id, product_type, product_name, gtin, lot_number,
        ...
        {!loading && !error && items.length === 0 && (
          <div className="rounded-xl border border-slate-200 bg-white p-8 text-center text-slate-600">
            ...
            <Link href="/delivery/new" className="mt-2 inline-block text-slate-800 underline">
